	    ...
	    wz0=float(k+1)-zeta/dzeta
            ...
            wx0*wy0*wz1*ezeta(i,j,k+1) + wx1*wy0*wz1*ezeta(i+1,j,k+1) + &
            wx0*wy1*wz1*ezeta(i,j+1,k+1) + wx1*wy1*wz1*ezeta(i+1,j+1,k+1)
            ...
            + wx0*wy0*wz1*delbz(i,j,k+1)  &
            + wx1*wy0*wz1*delbz(i+1,j,k+1)  &
            + wx0*wy1*wz1*delbz(i,j+1,k+1)  &
            + wx1*wy1*wz1*delbz(i+1,j+1,k+1)
